...
# Plot the summed s[a] at each 5m depth in the database

'Fig3_sum_sa.r' calculates a plot of the summed s[a] values at each depth, illustrating the overall relationship of krill density with depth.

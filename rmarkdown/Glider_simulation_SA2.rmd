...
# Run the simulation
The values above are the default arguments for gldrs() but they can be changed in the function call below.
...
After 'Gldr_simulation.rmd' has been rendered, the working directory will contain output files from the simulation. These can be plotted using 'Figures1_7.rmd', 'Fig8.rmd', or 'Fig9.rmd'.

...
source('Fig5.r')
Fig5(AMLR.area = 'WA',n.gldr=c(1,2,3,4,5))
```
...
source('Fig6.r')
Fig6(AMLR.area = 'WA',n.gldr=c(1))
```

Figure 6. Acoustic energy contours at depth for gliders with maximum yo depths
of 150 m. The true energies ("population"), and the means 9, 5 and one gliderare shown.
...
source('Fig7.r')
Fig7(AMLR.area = 'WA',gldr.pths = c(1))
Fig7(AMLR.area = 'WA',gldr.pths = c(2))
Fig7(AMLR.area = 'WA',gldr.pths = c(3))
Fig7(AMLR.area = 'WA',gldr.pths = c(4))
Fig7(AMLR.area = 'WA',gldr.pths = c(5))
```
...
Fig7_contours(AMLR.area = 'WA',n.gldr.pth = c(1,2,3,4,5))
Sys.time()
```

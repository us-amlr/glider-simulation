...
After 'Gldr_simulation.rmd' has been rendered, the working directory will contain output files from the simulation. These can be plotted using 'Figures.rmd' in the 'Figs' folder.
